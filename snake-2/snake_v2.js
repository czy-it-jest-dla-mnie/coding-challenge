...
function getSnakeCoordinates(mapSize, foodCoordinates, closestFoodCoordinates) {
...
function createSnakeEngine(canvasId, foodCounterId, mapSize, refreshInterval, foodCount, getSnakeCoordinates) {
    ...
    setInterval(() => {
        ...
        const snakeCoordinates = getSnakeCoordinates(mapSize, foodMap.getFoodCoordinates(), closestFoodCoordinates);
